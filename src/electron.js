...
app.on('ready', function createWindow() {
    ...
    win = new BrowserWindow({ width: 780, height: 585, title: 'Pixelmate', icon: __dirname + '/img/1.ico', webPreferences: { nodeIntegration: true, contextIsolation: false, enableRemoteModule: true } });
